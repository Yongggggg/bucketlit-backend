...
from bucketlit_api.blueprints.bucketlists.views import bucketlists_api_blueprint


app.register_blueprint(users_api_blueprint, url_prefix='/api/v1/users')
app.register_blueprint(sessions_api_blueprint, url_prefix='/api/v1/sessions')
app.register_blueprint(bucketlists_api_blueprint, url_prefix='/api/v1/bucketlists')
